  	...
  	<el-container style="height:99vh">
		<el-header height="auto">
			<el-row>
			  ...
			  <el-col :span="18" style="font-size:20px">采购申请历史</el-col>
			...
			<div class="block">	
			    ...
			    <div class="pickerValueInput">
		    		<el-input v-model="inputValue" placeholder="采购单/商品名/SKU" style="width:200px"></el-input>
		    		<el-button type="primary" @click="searchInfo" icon="el-icon-search">搜索</el-button>
		    		<el-button type="success" @click="toProcurement" icon="el-icon-refresh">新建采购</el-button>
			    </div>
			</div>
		</el-header> 
		<el-main>
	        <el-table :data="tableData.rows" border stripe size="small" height="auto" highlight-current-row style="height:calc(100% - 50px)">
	          ...
	          <el-table-column prop="Code" label="采购申请单号" width="150" align="center"></el-table-column>
	          ...
	          <el-table-column label="添加时间" align="center">
	          	<template slot-scope="scope">
	          		<span>{{formatDate(scope.row.DetialCreateDate)}}</span>
	          	</template>
	          </el-table-column>
	        </el-table>
	        <div class="pageUi">
...
<script>
	...
	export default{
		...
		computed: {
	      ...mapGetters(['DONE_PURCHASEHISTORY'])
	    },
		methods:{
			searchInfo(){
				var data = {
				...
				this.$store.dispatch('FECTH_PURCHASEHISTORY',data)
			},
